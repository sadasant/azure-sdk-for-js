...
import { RestoreOperationState, RestorePollOperationState, makeRestorePollOperation } from "./operation";
...
export class RestorePoller extends Poller<RestorePollOperationState, undefined> {
  ...
  constructor(options: RestorePollerOptions) {
    const { client, vaultUrl, blobStorageUri, sasToken, folderName, requestOptions, intervalInMs = 2000, resumeFrom } = options;
